...
class AmbulanceAgencyLocationPicker extends StatefulWidget {
  final Function(String) onLocationSelected;
  final String? initialLocation;

  const AmbulanceAgencyLocationPicker({
    Key? key,
  ...
  @override
  _AmbulanceAgencyLocationPickerState createState() => _AmbulanceAgencyLocationPickerState();
}

class _AmbulanceAgencyLocationPickerState extends State<AmbulanceAgencyLocationPicker> {
  final Completer<GoogleMapController> _mapController = Completer();
  LatLng _currentLocation = const LatLng(18.5204, 73.8567); // Default location (Pune)
