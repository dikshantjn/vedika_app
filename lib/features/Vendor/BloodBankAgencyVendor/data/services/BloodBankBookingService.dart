    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (response.data is Map<String, dynamic>) {
          ...
          if (responseMap.containsKey('agency') && responseMap['agency'] != null) {
            agency = BloodBankAgency.fromMinimalJson(responseMap['agency']);
          }
          ...
          if (responseMap.containsKey('data') && responseMap['data'] != null) {
            if (responseMap['data'] is List) {
              ...
              // Map the data and include agency in each booking
              return data.map((json) {
                // Add agency to each booking's JSON if available
                if (agency != null) {
                  json['agency'] = agency.toJson();
                }
