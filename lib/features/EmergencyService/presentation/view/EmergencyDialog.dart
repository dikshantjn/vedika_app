                ...
                children: [
                  ...
                  if (!viewModel.showOptions) ...[
                    viewModel.isLoading
                      ...
                      children: const [
                        ...
                        : ElevatedButton(
                      onPressed: () {
                        viewModel.checkLocationEnabled(context); // Check location when user agrees to call
                      },
                  ...
                  if (viewModel.showOptions) ...[
                    _buildOptionButton(
                      ...
                      Colors.blueAccent,
                      Icons.call,
                          () => context.read<EmergencyService>().triggerDoctorEmergency(doctorNumber),
                    ),
                    const SizedBox(height: 15),
                    ...
                    _buildOptionButton(
                      ...
                      Icons.local_hospital,
                          () => context.read<EmergencyService>().triggerAmbulanceEmergency(ambulanceNumber),
                    ),
                    const SizedBox(height: 15),
                    ...
                    _buildOptionButton(
                      ...
                      Colors.pinkAccent,
                      Icons.bloodtype,
                          () => context.read<EmergencyService>().triggerBloodBankEmergency(bloodBankNumber),
                    ),
                    const SizedBox(height: 25),
                  ],
