...
import 'package:vedika_healthcare/features/hospital/presentation/widgets/DoctorSelection.dart';
...
class BookAppointmentPage extends StatelessWidget {
  ...
  final GlobalKey<FormState> _patientFormKey = GlobalKey<FormState>(); // Form key for validation
   ...
   BookAppointmentPage({Key? key, required this.hospital}) : super(key: key);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Patient Details Selection with Modern Toggle UI
...
// Fees Display
            if (viewModel.selectedDoctor != null) ...[
              ...
              SizedBox(height: 5),
              Text("₹${viewModel.selectedDoctor!['fee']}",
              ...
              child: ElevatedButton(
                onPressed: () {
                  if (viewModel.selectedPatientType == "Other" && !_patientFormKey.currentState!.validate()) {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please complete all patient details")));
                  } else if (!viewModel.isFormComplete()) {
