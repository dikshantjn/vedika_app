...
class MedicalStoreVendorColorPalette {
  ...
  static const Color surfaceColor = Color(0xFFECF0F1); // Lighter Gray
  ...
  static const Color onlineColor = Color(0xFF27AE60); // Green
  static const Color offlineColor = Color(0xFF95A5A6); // Gray
  static const Color busyColor = Color(0xFFE74C3C); // Red
  static const Color awayColor = Color(0xFFF39C12); // Orange
}
